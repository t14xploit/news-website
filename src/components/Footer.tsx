...
export default function Footer() {
  return (
    <footer className=" max-w-screen-xl w-full pt-4 px-6 mx-auto border-t border-border bg-background text-foreground   text-sm">
      <div className=" mx-auto flex flex-col gap-10 md:flex-row md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-16">
          <div className="space-y-2">
            ...
            <Link href="/subscription" className="block hover:underline">
              Subscriptions
            </Link>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Link href="/editors-choice" className="block hover:underline">
              Editor’s Choice
            </Link>
            <Link href="/top-news" className="block hover:underline">
              Top News
            </Link>
            <Link href="/weather" className="block hover:underline">
              Weather
            </Link>
            <Link href="/experts" className="block hover:underline">
              Expert Views
            </Link>
            <Link href="/economy" className="block hover:underline">
              Business & Economy
            </Link>
          </div>
        </div>
