  ...
  useEffect(() => {
    async function loadSavedCards() {
      try {
        ...
        const sanitizedCards = cards.map((card: SavedCard) => {
          return {
            ...
            cardBackground: card.cardBackground || "black",
            plan: card.plan || "Free",
          ...
          <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
            ...
            <DialogContent className="bg-gray-900 text-white/90">
              ...
              >
                ...
                <Button
                  type="submit"
                  className="w-full btn-blue bg-blue-600 hover:bg-blue-700"
                >
